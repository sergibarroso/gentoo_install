...
```shell
curl -o /mnt/gentoo/stage3-amd64-systemd.tar.xz -L https://distfiles.gentoo.org/releases/amd64/autobuilds/current-stage3-amd64-systemd/stage3-amd64-systemd-20260125T170113Z.tar.xz
```
